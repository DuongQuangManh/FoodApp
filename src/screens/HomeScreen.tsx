...
const HomeScreen = () => {
    ...
    const product = useSelector((state: RootState) => {
        const a = state.productSlice.data.filter((item: any) => {
        ...
        <View style={styles.container}>
            ...
            <View style={{ height: '100%', marginTop: 20, paddingTop: 40, }}>
                ...
                <View style={{
                    ...
                    <Text style={[styles.textsm, { fontWeight: 'bold' }]}>Popular {category.nameSelect}</Text>
                ...
                <View style={{ width: WINDOW_WIDTH, height: WINDOW_HEIGHT / 2 - 20 }}>
                    <FlatList
                        showsHorizontalScrollIndicator={false}
                        data={product}
                        renderItem={({ item }) => <ItemSmall item={item} navi={handlerDetails} />}
                        horizontal
